      ...
      <div className={styles.frameParent}>
        <div className={styles.frameGroup}>
          <div className={styles.loremIpsumDolorSitAmetCoParent}>
            <h2 className={styles.loremIpsumDolorContainer}>
        ...
        <div className={styles.frameParent1}>
          <div className={styles.loremIpsumDolorSitAmetCoParent1}>
        ...
        <div className={styles.frameParent2}>
          <div className={styles.loremIpsumDolorSitAmetCoParent2}>
        ...
        <div className={styles.frameParent3}>
          <div className={styles.loremIpsumDolorSitAmetCoParent3}>
        ...
        <div className={styles.frameParent4}>
          <div className={styles.loremIpsumDolorSitAmetCoParent4}>
