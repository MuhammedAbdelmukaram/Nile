import styles from './BridgeI.module.css'

const BridgeICategories = () => {
  return (
      ...
      <div className={styles.kreoHiveAntiGhostingGamingParent}>
        ...
        <div className={styles.groupParent}>
          ...
          <div className={styles.vectorParent}>
            <img className={styles.vectorIcon} alt="" src="/vector60@2x.png" />
            <img className={styles.vectorIcon} alt="" src="/vector61@2x.png" />
            <img className={styles.vectorIcon} alt="" src="/vector62@2x.png" />
            <img className={styles.vectorIcon} alt="" src="/vector63@2x.png" />
            <img className={styles.vectorIcon4} alt="" src="/vector64@2x.png" />
          </div>
        </div>
...
export default BridgeICategories;
